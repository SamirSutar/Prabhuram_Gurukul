...
export default function NB() {
    ...
    return (
        <nav className="w-full sticky top-0 left-0 lg:max-w-7xl z-40 flex bg-[#767171] max-w-7xl">
            <div className="flex justify-start lg:w-[35%]">
                ...
                <h1 className="text-white text-3xl font-serif pt-3 pl-1 uppercase">Prabhuram Gurukul</h1>
            </div>
                    ...
                    <div className={`flex-1 justify-self-center pb-3 mt-8 md:block md:pb-0 md:mt-0 ${navbar ? "block" : "hidden"}`}>
                        <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                            ...
                            <li className="group max-lg:border-b max-lg:py-2 relative">
                                ...
                                <ul className="absolute hidden group-hover:block shadow-lg bg-[#767171] backdrop-blur-3xl px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-lg:pl-4">
                            ...
                            <li className="group max-lg:border-b max-lg:py-2 relative">
                                ...
                                <ul className="absolute hidden group-hover:block shadow-lg bg-[#767171] backdrop-blur-3xl px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-lg:pl-4">
                                    ...
                                    <li className="border-b py-2 max-lg:ml-4">
                                        <Link to="/aboutmanagement" onClick={handleLinkClick} className="hover:text-white text-white text-[15px] font-serif block text-left hover:bg-gray-700 px-4 py-2 rounded-md uppercase">Syllabus</Link>
                                    </li>
